...
?> 
      ...
      <ul>
        ...
        <?php $_from = $this->_var['help_cat']['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_45583800_1468330401');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_45583800_1468330401']):
?>
        <li><a target="_blank" href="<?php echo $this->_var['item_0_45583800_1468330401']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['item_0_45583800_1468330401']['title']); ?>" ><?php echo $this->_var['item_0_45583800_1468330401']['short_title']; ?></a></li>
  ...
  <dd class="indexw_friend_link">
    <ul id="link_slide">
      <li> 
        ...
        <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_45597800_1468330401');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_45597800_1468330401']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?> 
        <a href="<?php echo $this->_var['nav_0_45597800_1468330401']['url']; ?>"  > <?php echo $this->_var['nav_0_45597800_1468330401']['name']; ?></a> <?php if (! ($this->_foreach['nav_bottom_list']['iteration'] == $this->_foreach['nav_bottom_list']['total'])): ?><span>|</span><?php endif; ?> 
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
        <?php endif; ?> 
      </li>
    </ul>
