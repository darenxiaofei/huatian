...
<!--
// 这里把JS用到的所有语言都赋值到这里
<?php $_from = $this->_var['lang']['js_languages']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_31618400_1468331078');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_31618400_1468331078']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_31618400_1468331078']; ?>";
