...
<div class="box">
 <div class="box_1">
  ...
  <form method="GET" class="sort" name="listform">
    ...
    <li>  <a href="category.php?category=21&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=DESC#goods_list">
    <img src="themes/ecmoban_zsxn/images/shop_price_ASC.gif" alt="按价格排序"></a>
    </li>
    <li>  <a href="category.php?category=21&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list">
