...
<div class="box">
 <div class="box_1">
  ...
  <form method="GET" class="sort" name="listform">
    ...
    <img src="themes/ecmoban_zsxn/images/goods_id_ASC.gif" alt="按上架时间排序"></a>
    </li>
