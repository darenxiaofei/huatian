...
<title>女装_ECSHOP演示站 - Powered by ECShop</title>
...
<div class="menu_box clearfix">
  <div class="block">
    <div class="menu"> <a href="index.php">首页<span></span></a> 
      ...
      <a href="category.php?id=21"   class="cur"> 女装 <span></span> </a> 
...
<div class="box">
 <div class="box_1">
  ...
  <form method="GET" class="sort" name="listform">
    ...
    <li>  <a href="category.php?category=21&display=list&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">
    <img src="themes/ecmoban_zsxn/images/goods_id_default.gif" alt="按上架时间排序"></a>
    </li>
    <li>  <a href="category.php?category=21&display=list&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">
    <img src="themes/ecmoban_zsxn/images/shop_price_default.gif" alt="按价格排序"></a>
    </li>
    <li>  <a href="category.php?category=21&display=list&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=ASC#goods_list">
    <img src="themes/ecmoban_zsxn/images/last_update_DESC.gif" alt="按更新时间排序"></a>
    </li>
...
>&nbsp;&nbsp;Licensed</a><br />
                <div align="left"  id="rss"><a href="feed.php?cat=21"><img src="themes/ecmoban_zsxn/images/xml_rss2.gif" alt="rss" /></a></div>
      </div>
    </div>
